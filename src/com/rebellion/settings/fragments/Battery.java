...
public class Battery extends SettingsPreferenceFragment implements 
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.rebellion_settings_battery);
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        if (preference == mSmartPixelsEnabled) {
            ...
            Intent service = (new Intent())
                .setClassName("com.android.systemui", "com.android.systemui.rebellion.screenstate.ScreenStateService");
            if (value) {
